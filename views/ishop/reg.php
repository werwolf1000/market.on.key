    ...
    <form method="post" action="#">
        <table class="zakaz-data" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td class="zakaz-inpt"><input required type="text" name="login"
                                              value="<?= $_SESSION['reg']['login'] ?>"/></td>
                <td class="zakaz-prim"></td>
            </tr>
            <tr>
                <td class="zakaz-txt">*Пароль</td>
                <td class="zakaz-inpt"><input required type="password" name="pass"/></td>
                <td class="zakaz-prim"></td>
            </tr>
            <tr>
                <td class="zakaz-txt">*ФИО</td>
                <td class="zakaz-inpt"><input required type="text" name="name" value="<?= $_SESSION['reg']['name'] ?>"/>
                </td>
                <td class="zakaz-prim">Пример: Иванов Сергей Александрович</td>
            </tr>
            <tr>
                <td class="zakaz-txt">*Е-маил</td>
                <td class="zakaz-inpt"><input required type="text" name="email"
                                              value="<?= $_SESSION['reg']['email'] ?>"/></td>
                <td class="zakaz-prim">Пример: test@mail.ru</td>
            </tr>
            <tr>
                <td class="zakaz-txt">*Телефон</td>
                <td class="zakaz-inpt"><input required type="text" name="phone"
                                              value="<?= $_SESSION['reg']['phone'] ?>"/></td>
                <td class="zakaz-prim">Пример: 8 937 999 99 99</td>
            </tr>
            <tr>
                <td class="zakaz-txt">*Адрес доставки</td>
                <td class="zakaz-inpt"><input required type="text" name="address"
                                              value="<?= $_SESSION['reg']['addres'] ?>"/>
                </td>
