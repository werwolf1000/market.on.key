...
(function () {
    ...
    (function () {
        var l = e.extend({table: 1, ul: 1, ol: 1, dl: 1}, f.table, f.ul, f.ol, f.dl), m = c && b.version < 8 ? {
            dd: 1,
            dt: 1
        } : {}, n = {ol: 1, ul: 1}, o = e.extend({}, {html: 1}, f.html, f.body, f.head, {style: 1, script: 1});
    ...
    (function () {
        var l = {
            ...
            legend: 1,
            caption: 1
        }, m = {body: 1, div: 1, table: 1, tbody: 1, tr: 1, td: 1, th: 1, form: 1, fieldset: 1}, n = function (o) {
            var p = o.getChildren();
    ...
    (function () {
        j.add('div', {
            requires: ['editingblock', 'dialog', 'domiterator', 'styles'], init: function (m) {
                var n = m.lang.div;
    ...
    (function () {
        j.add('enterkey', {
            requires: ['keystrokes', 'indent'], init: function (t) {
                t.addCommand('enter', {
                    modes: {wysiwyg: 1}, editorFocus: false, exec: function (v) {
                        r(v);
                    }
                });
    ...
    (function () {
        ...
        j.add('htmldataprocessor', {
            requires: ['htmlwriter'], init: function (U) {
    ...
    j.add('link', {
        requires: ['fakeobjects', 'dialog'], init: function (m) {
            ...
            if (m.addMenuItems)m.addMenuItems({
                ...
                removeAnchor: {label: m.lang.anchor.remove, command: 'removeAnchor', group: 'anchor', order: 5},
        ...
        j.add('maximize', {
            init: function (s) {
                ...
                s.addCommand('maximize', {
                    modes: {wysiwyg: !b.iOS, source: !b.iOS}, readOnly: 1, editorFocus: false, exec: function () {
    ...
    (function () {
        var m, n = {
            modes: {wysiwyg: 1, source: 1}, canUndo: false, readOnly: 1, exec: function (p) {
    ...
    (function () {
        var m = {
            modes: {wysiwyg: 1, source: 1}, readOnly: 1, exec: function (o) {
    ...
    (function () {
        ...
        j.tabletools = {
            requires: ['table', 'dialog'], init: function (G) {
                var H = G.lang.table;
    ...
    (function () {
        ...
        j.add('toolbar', {
            requires: ['button'], init: function (o) {
    ...
    (function () {
        ...
        a.dialog.prototype = {
            destroy: function () {
                ...
                var ad = this;
                var S = [], T = R.label ? ' title="' + e.htmlEncode(R.label) + '"' : '', U = R.elements, V = a.dialog._.uiElementBuilders.vbox.build(ad, {
                    type: 'vbox',
    ...
    (function () {
        ...
        var s = {
            modes: {wysiwyg: 1, source: 1}, readOnly: c || b.webkit, exec: function (D) {
                switch (D.mode) {
                    case 'wysiwyg':
                ...
                var D = c ? (function () {
                    ...
                    var F = function (G, H) {
                        ...
                        if (Q == -1 || Q == K.length - 1 && R < 0) {
                            ...
                            if (!S) {
                                L = K[K.length - 1];
                                if (L.nodeType != 3)return {container: I, offset: K.length}; else return {
                                    container: L,
        ...
        var z = d.walker.whitespaces(true), A = d.walker.invisible(1), B = /\ufeff|\u00a0/, C = {
            table: 1,
            tbody: 1,
            tr: 1
        };
