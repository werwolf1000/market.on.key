...
CKEDITOR.dialog.add('link', function (a) {
                ...
                if (S) {
                    ...
                    while (T = o.exec(S[2])) {
                        if ((T[2] == 'yes' || T[2] == '1') && !(T[1] in {
                                ...
                                top: 1,
                                left: 1
                            }))M.target[T[1]] = true; else if (isFinite(T[2]))M.target[T[1]] = T[2];
                    }
                }
            } else {
                var U = Q.match(k);
    ...
    return {
        title: E.title, minWidth: 350, minHeight: 230, contents: [{
            id: 'info',
            label: E.info,
            title: E.info,
            elements: [{
                ...
                label: E.type,
                'default': 'url',
                items: [[E.toUrl, 'url'], [E.toAnchor, 'anchor'], [E.toEmail, 'email']],
                onChange: d,
                setup: function (F) {
            ...
            elements: [{
                ...
                children: [{
                    type: 'hbox',
                    widths: ['45%', '35%', '20%'],
                    children: [{type: 'text', id: 'advId', label: E.id, setup: s, commit: v}, {
                        type: 'select',
                        id: 'advLangDir',
                        label: E.langDir,
                        'default': '',
                        style: 'width:110px',
                        items: [[D.notSet, ''], [E.langDirLTR, 'ltr'], [E.langDirRTL, 'rtl']],
                        setup: s,
                        commit: v
                    }, {
                        type: 'text',
                    ...
                    type: 'hbox',
                    widths: ['45%', '35%', '20%'],
                    children: [{type: 'text', label: E.name, id: 'advName', setup: s, commit: v}, {
                        type: 'text',
                        label: E.langCode,
                        id: 'advLangCode',
                        width: '110px',
