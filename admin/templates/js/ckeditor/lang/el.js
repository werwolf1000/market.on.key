...
CKEDITOR.lang.el = {
    ...
    smiley: {toolbar: 'Smiley', title: 'Επιλέξτε ένα Smiley', options: 'Smiley Options'},
    ...
    font: {label: 'Γραμματοσειρά', voiceLabel: 'Font', panelTitle: 'Όνομα Γραμματοσειράς'},
    fontSize: {label: 'Μέγεθος', voiceLabel: 'Font Size', panelTitle: 'Μέγεθος Γραμματοσειράς'},
    colorButton: {
