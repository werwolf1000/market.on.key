...
CKEDITOR.lang.ka = {
    ...
    smiley: {toolbar: 'სიცილაკები', title: 'სიცილაკის ჩასმა', options: 'სიცილაკის პარამეტრები'},
    ...
    justify: {left: 'მარცხნივ სწორება', center: 'შუაში სწორება', right: 'მარჯვნივ სწორება', block: 'გადასწორება'},
    blockquote: 'ციტატა',
    clipboard: {
        title: 'ჩასმა',
    ...
    font: {label: 'ფონტი', voiceLabel: 'ფონტი', panelTitle: 'ფონტის სახელი'},
