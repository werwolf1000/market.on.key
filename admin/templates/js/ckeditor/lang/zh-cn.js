...
CKEDITOR.lang['zh-cn'] = {
    ...
    iframe: {title: 'IFrame 属性', toolbar: 'IFrame', noUrl: '请输入框架的 URL', scrolling: '允许滚动条', border: '显示框架边框'},
    ...
    maximize: '全屏',
    minimize: '最小化',
    fakeobjects: {anchor: '锚点', flash: 'Flash 动画', iframe: 'IFrame', hiddenfield: '隐藏域', unknown: '未知对象'},
    resize: '拖拽以改变尺寸',
